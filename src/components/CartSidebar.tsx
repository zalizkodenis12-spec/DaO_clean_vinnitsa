      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 w-full max-w-[400px] h-[100dvh] bg-[#FBBF24] z-[100] flex flex-col shadow-2xl"
          >
            {/* Wavy Left Edge */}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 relative z-10">
              {items.length === 0 ? (
                ...
                items.map((item) => (
                  <div key={item.id} className="bg-[#FEF3C7] rounded-2xl p-4 shadow-lg flex items-center gap-4">
            ...
            {/* Footer / Checkout */}
            <div className="p-6 bg-[#FBBF24] border-t border-white/10 relative z-10">

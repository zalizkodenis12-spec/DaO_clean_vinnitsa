...
export default function MenuSection() {
  return (
    <section id="menu" className="relative w-full bg-[#FFC107] z-20 pb-32">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 md:pt-24 pb-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-16">
          ...
          >
            ...
            <div className="w-full aspect-[3/4] bg-[#FFF3D6] rounded-3xl shadow-2xl overflow-hidden flex items-center justify-center">
              <svg
                viewBox="0 0 200 240"
                fill="none"
              ...
              >
                ...
                <ellipse cx="100" cy="210" rx="80" ry="60" fill="#FFC107" />
              </svg>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg md:text-2xl font-medium opacity-90 mb-8 leading-relaxed max-w-xl">
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                <motion.li
                  ...
                  className="flex items-center gap-3 text-lg md:text-xl font-semibold"
                >

    ...
    <footer id="contacts" className="relative w-full bg-[#FACC15] text-[#FFFFFF] pt-8 pb-12 z-20">
          ...
          <div className="flex flex-col items-start w-[48%] md:w-full md:max-w-[280px]">
            ...
            <div className="flex flex-col gap-4 md:gap-5 w-full">
              ...
              <a href="https://www.instagram.com/daocleanvinnytsia/" target="_blank" rel="noreferrer" className="group flex items-center gap-2 md:gap-4 hover:-translate-y-1 transition-transform text-left">
                <div className="w-8 h-8 md:w-14 md:h-14 bg-white text-[#E8940F] rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow shrink-0">
      ...
      <div className="w-full flex flex-col md:flex-row justify-center items-center gap-2 md:gap-8 text-center text-[#FFFFFF]/60 text-sm mt-12 md:mt-16 pt-8 border-t border-white/20 max-w-7xl mx-auto px-6 font-semibold">
        ...
        <div className="flex gap-4 mt-2 md:mt-0">
          <Link href="/privacy-policy" className="text-[#E8940F] hover:text-white hover:underline transition-all">Політика конфіденційності</Link>
          <Link href="/terms-of-use" className="text-[#E8940F] hover:text-white hover:underline transition-all">Умови користування</Link>
        </div>
      </div>
    </footer>
  );

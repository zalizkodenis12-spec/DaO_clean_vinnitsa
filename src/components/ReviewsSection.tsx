...
const REVIEWS = [
  ...
  },
  {
    name: "Максим П.",
    role: "клієнт",
    text: "Здавав дорогу шкіряну куртку і дуже боявся, що її зіпсують. Але все зробили максимально акуратно — повернули ідеальний вигляд та повністю прибрали сторонній запах. Сервісом абсолютно задоволений!",
    rating: 5,
  },
  {
    name: "Марина В.",

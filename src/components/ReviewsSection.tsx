...
const REVIEWS = [
  {
    name: "Олена К.",
    role: "клієнтка",
    text: "Замовляли чистку дивана, який був весь у плямах від дитячих соків та фарб — чесно кажучи, думала вже нічого не допоможе і доведеться купувати новий. Майстер приїхав у чітко домовлений час, акуратно все почистив буквально за пару годин без різких запахів хімії. Після висихання диван дійсно виглядає як новий, тканина знову стала м'якою на дотик!",
    rating: 5,
  },
  {
    name: "Максим П.",
    role: "клієнт",
    text: "Здавав дорогу шкіряну куртку після кількох сезонів носіння. Дуже боявся, що шкіру можуть зіпсувати або пересушити агресивними засобами. Але все зробили максимально акуратно — повернули не лише ідеальний вигляд та блиск, а ще й повністю прибрали застарілий запах тютюну. Сервісом абсолютно задоволений, обов'язково звертатимусь ще!",
    rating: 5,
  },
  {
    name: "Марина В.",
    role: "клієнтка",
    text: "Замовляла комплексну чистку великого світлого килима перед святами. Хлопці приїхали вчасно зі своїм обладнанням, зробили все дуже швидко і, що найголовніше, без зайвого бруду чи калюж води у квартирі. Всі затоптані місця відчистилися ідеально, ворс піднявся, а в кімнаті тепер приємно пахне свіжістю. Дуже задоволена роботою!",
    rating: 5,
  },
];

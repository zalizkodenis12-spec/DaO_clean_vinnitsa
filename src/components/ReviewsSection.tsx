...
const REVIEWS = [
  {
    name: "Олена К.",
    role: "клієнтка",
    text: "Дякую за чудово проведену роботу! Запах і п'ятна повністю зникли! А спілкування з Олегом залишило приємні спогади, дуже приємний, добрий, працьовитий чоловік!",
    rating: 5,
  },
  {
    name: "Максим П.",
    role: "клієнт",
    text: "Хочу подякувати за чудову роботу, за оперативність , виконано на вищому рівні. Ви майстер своєї справи....Рекомендую, будете задоволені на всі 100%.",
    rating: 5,
  },
  {
    name: "Марина В.",
    role: "клієнтка",
    text: "Дякую, Олегу за чудову роботу , він дав друге життя м'якому уголкові у вітальні ,став як новий.Олег добросовісний і відповідальний, так що рекомендую хто ще не може наважитися вперед не пошкодуєте.",
    rating: 5,
  },
];
...
export default function ReviewsSection() {
  return (
    <section id="reviews" className="relative w-full bg-[#FEF9C3] z-10 py-16 md:py-32 overflow-hidden min-h-[90vh] flex flex-col justify-center">

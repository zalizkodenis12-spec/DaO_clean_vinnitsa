...
const REVIEWS = [
  ...
  },
  {
    name: "Гість DaO Clean",
    role: "Постійний клієнт",
    text: "Найсмачніша кава, чай, випічка, все завжди свіже, дуже круті баристи які роблять гарний настрій своїм відношенням до клієнтів, тобі хочеться повертатися туди ще і ще. Я обожнюю цю кав'ярню, там неймовірний затишок.",
    rating: 5,
  },
];

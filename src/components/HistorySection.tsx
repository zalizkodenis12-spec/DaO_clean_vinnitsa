...
export default function HistorySection() {
  return (
    <section id="history" className="relative w-full bg-[#B0D8FF] z-10 flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-1/2 h-[40vh] md:h-screen relative md:sticky top-0 bg-[#F9F9F9] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#B0D8FF]/70"></div>
      ...
      <div className="w-full md:w-1/2 bg-[#B0D8FF] flex flex-col py-16 md:py-[20vh] px-6 md:px-24">

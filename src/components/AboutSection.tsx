...
export default function AboutSection() {
  return (
    <section id="about" className="relative w-full bg-[#0158C4] z-20 pt-16 md:pt-24 pb-16 md:pb-32">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none text-[#B0D8FF]">
          ...
          >
            ...
            <SwiperSlide>
              <div className="flex flex-col items-center text-center group h-full cursor-grab active:cursor-grabbing px-2 py-4">
                <div className="w-28 h-28 rounded-full border-4 border-[#B0D8FF] flex items-center justify-center mb-6 group-hover:bg-[#B0D8FF] group-hover:text-[#0158C4] transition-colors duration-300">

...
export default function AboutSection() {
  return (
    <section id="about" className="relative w-full bg-[#FACC15] z-20 pt-16 md:pt-24 pb-16 md:pb-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-[#FFFFFF] flex flex-col items-center">
        ...
        >
          ...
          <p className="text-xl md:text-3xl font-medium max-w-4xl mx-auto leading-relaxed mb-8 md:mb-24">
            Ми — команда професіоналів з виїзної хімчистки меблів. Дивани, матраци, крісла, килими — повертаємо їм вигляд як новий, прямо у вас вдома. Працюємо з делікатними тканинами та шкірою так, щоб кожна річ була в безпечних руках.
          </p>
        </motion.div>
          ...
          >
            ...
            <SwiperSlide>
              <div className="flex flex-col items-center text-center group h-full cursor-grab active:cursor-grabbing px-2 py-4">
                <div className="w-28 h-28 rounded-full border-4 border-[#E8F1FA] flex items-center justify-center mb-6 group-hover:bg-[#E8F1FA] group-hover:text-[#FACC15] transition-colors duration-300">
